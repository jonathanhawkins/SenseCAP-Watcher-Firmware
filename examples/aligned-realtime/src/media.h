...
/// Stops the media systems (capturer and renderer).
/// Call this before destroying a LiveKit room to ensure clean shutdown.
/// After calling this, media_reset() must be called before joining a new room.
void media_stop(void);

/// Resets the media systems after a disconnect.
/// This re-initializes the capturer and renderer for a new connection.
