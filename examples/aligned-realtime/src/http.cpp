...
// For Aligned mode, we use device token instead of OpenAI API key
extern char g_openai_api_key_buf[165];  // Keep for backward compatibility

// Get device token from aligned_client.cpp
extern const char* aligned_get_device_token(void);
