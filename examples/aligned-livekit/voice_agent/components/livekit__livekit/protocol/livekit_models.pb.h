...
typedef enum livekit_pb_data_track_extension_id {
    LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_DTEI_INVALID = 0,
    LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_DTEI_PARTICIPANT_SID = 1
} livekit_pb_data_track_extension_id_t;
...
typedef enum livekit_pb_participant_info_kind_detail {
    ...
    LIVEKIT_PB_PARTICIPANT_INFO_KIND_DETAIL_CONNECTOR_WHATSAPP = 2,
    LIVEKIT_PB_PARTICIPANT_INFO_KIND_DETAIL_CONNECTOR_TWILIO = 3
...
typedef struct livekit_pb_data_track_info {
...
} livekit_pb_data_track_info_t;

typedef struct livekit_pb_data_track_extension_participant_sid {
    livekit_pb_data_track_extension_id_t id;
    pb_callback_t participant_sid;
} livekit_pb_data_track_extension_participant_sid_t;

typedef struct livekit_pb_data_track_subscription_options {
 ...
 If omitted, the subscriber defaults to the publisher's fps */
    bool has_target_fps;
    uint32_t target_fps;
} livekit_pb_data_track_subscription_options_t;
...
#define _LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_MIN LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_DTEI_INVALID
#define _LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_MAX LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_DTEI_PARTICIPANT_SID
#define _LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_ARRAYSIZE ((livekit_pb_data_track_extension_id_t)(LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_DTEI_PARTICIPANT_SID+1))
...
#define _LIVEKIT_PB_PARTICIPANT_INFO_KIND_DETAIL_MAX LIVEKIT_PB_PARTICIPANT_INFO_KIND_DETAIL_CONNECTOR_TWILIO
#define _LIVEKIT_PB_PARTICIPANT_INFO_KIND_DETAIL_ARRAYSIZE ((livekit_pb_participant_info_kind_detail_t)(LIVEKIT_PB_PARTICIPANT_INFO_KIND_DETAIL_CONNECTOR_TWILIO+1))
...
#define livekit_pb_data_track_info_t_encryption_ENUMTYPE livekit_pb_encryption_type_t

#define livekit_pb_data_track_extension_participant_sid_t_id_ENUMTYPE livekit_pb_data_track_extension_id_t
...
#define LIVEKIT_PB_PARTICIPANT_INFO_INIT_DEFAULT {"", NULL, _LIVEKIT_PB_PARTICIPANT_INFO_STATE_MIN, 0, NULL, NULL, NULL, LIVEKIT_PB_PARTICIPANT_PERMISSION_INIT_DEFAULT, _LIVEKIT_PB_PARTICIPANT_INFO_KIND_MIN, {{NULL}, NULL}}
...
#define LIVEKIT_PB_DATA_TRACK_INFO_INIT_DEFAULT  {0, {{NULL}, NULL}, {{NULL}, NULL}, _LIVEKIT_PB_ENCRYPTION_TYPE_MIN}
#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_INIT_DEFAULT {_LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_MIN, {{NULL}, NULL}}
#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_INIT_DEFAULT {false, 0}
...
#define LIVEKIT_PB_PARTICIPANT_INFO_INIT_ZERO    {"", NULL, _LIVEKIT_PB_PARTICIPANT_INFO_STATE_MIN, 0, NULL, NULL, NULL, LIVEKIT_PB_PARTICIPANT_PERMISSION_INIT_ZERO, _LIVEKIT_PB_PARTICIPANT_INFO_KIND_MIN, {{NULL}, NULL}}
...
#define LIVEKIT_PB_DATA_TRACK_INFO_INIT_ZERO     {0, {{NULL}, NULL}, {{NULL}, NULL}, _LIVEKIT_PB_ENCRYPTION_TYPE_MIN}
#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_INIT_ZERO {_LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_MIN, {{NULL}, NULL}}
#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_INIT_ZERO {false, 0}
...
#define LIVEKIT_PB_PARTICIPANT_INFO_DATA_TRACKS_TAG 19
...
#define LIVEKIT_PB_DATA_TRACK_INFO_PUB_HANDLE_TAG 1
#define LIVEKIT_PB_DATA_TRACK_INFO_SID_TAG       2
#define LIVEKIT_PB_DATA_TRACK_INFO_NAME_TAG      3
#define LIVEKIT_PB_DATA_TRACK_INFO_ENCRYPTION_TAG 4
#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_ID_TAG 1
#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_PARTICIPANT_SID_TAG 2
#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_TARGET_FPS_TAG 1
...
X(a, CALLBACK, REPEATED, MESSAGE,  data_tracks,      19)
#define LIVEKIT_PB_PARTICIPANT_INFO_CALLBACK pb_default_field_callback
...
#define livekit_pb_participant_info_t_data_tracks_MSGTYPE livekit_pb_data_track_info_t
...
#define LIVEKIT_PB_DATA_TRACK_INFO_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   pub_handle,        1) \
X(a, CALLBACK, SINGULAR, STRING,   sid,               2) \
X(a, CALLBACK, SINGULAR, STRING,   name,              3) \
X(a, STATIC,   SINGULAR, UENUM,    encryption,        4)
#define LIVEKIT_PB_DATA_TRACK_INFO_CALLBACK pb_default_field_callback
#define LIVEKIT_PB_DATA_TRACK_INFO_DEFAULT NULL

#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UENUM,    id,                1) \
X(a, CALLBACK, SINGULAR, STRING,   participant_sid,   2)
#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_CALLBACK pb_default_field_callback
#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_DEFAULT NULL

#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_FIELDLIST(X, a) \
X(a, STATIC,   OPTIONAL, UINT32,   target_fps,        1)
#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_CALLBACK NULL
#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_DEFAULT NULL
...
extern const pb_msgdesc_t livekit_pb_data_track_info_t_msg;
extern const pb_msgdesc_t livekit_pb_data_track_extension_participant_sid_t_msg;
extern const pb_msgdesc_t livekit_pb_data_track_subscription_options_t_msg;
...
#define LIVEKIT_PB_DATA_TRACK_INFO_FIELDS &livekit_pb_data_track_info_t_msg
#define LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_FIELDS &livekit_pb_data_track_extension_participant_sid_t_msg
#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_FIELDS &livekit_pb_data_track_subscription_options_t_msg
...
/* livekit_pb_DataTrackInfo_size depends on runtime parameters */
/* livekit_pb_DataTrackExtensionParticipantSid_size depends on runtime parameters */
...
#define LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_SIZE 6
...
#define livekit_DataTrackExtensionID livekit_pb_DataTrackExtensionID
...
#define livekit_DataTrackInfo livekit_pb_DataTrackInfo
#define livekit_DataTrackExtensionParticipantSid livekit_pb_DataTrackExtensionParticipantSid
#define livekit_DataTrackSubscriptionOptions livekit_pb_DataTrackSubscriptionOptions
...
#define _LIVEKIT_DATA_TRACK_EXTENSION_ID_MIN _LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_MIN
#define _LIVEKIT_DATA_TRACK_EXTENSION_ID_MAX _LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_MAX
#define _LIVEKIT_DATA_TRACK_EXTENSION_ID_ARRAYSIZE _LIVEKIT_PB_DATA_TRACK_EXTENSION_ID_ARRAYSIZE
...
#define LIVEKIT_DATA_TRACK_INFO_INIT_DEFAULT LIVEKIT_PB_DATA_TRACK_INFO_INIT_DEFAULT
#define LIVEKIT_DATA_TRACK_EXTENSION_PARTICIPANT_SID_INIT_DEFAULT LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_INIT_DEFAULT
#define LIVEKIT_DATA_TRACK_SUBSCRIPTION_OPTIONS_INIT_DEFAULT LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_INIT_DEFAULT
...
#define LIVEKIT_DATA_TRACK_INFO_INIT_ZERO LIVEKIT_PB_DATA_TRACK_INFO_INIT_ZERO
#define LIVEKIT_DATA_TRACK_EXTENSION_PARTICIPANT_SID_INIT_ZERO LIVEKIT_PB_DATA_TRACK_EXTENSION_PARTICIPANT_SID_INIT_ZERO
#define LIVEKIT_DATA_TRACK_SUBSCRIPTION_OPTIONS_INIT_ZERO LIVEKIT_PB_DATA_TRACK_SUBSCRIPTION_OPTIONS_INIT_ZERO
